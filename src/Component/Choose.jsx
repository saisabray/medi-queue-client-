              ...
              >
                <CardContent className="p-8">
                  <div className="relative w-14 h-14 mb-6 flex items-center justify-center">
                    <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-cyan-400 to-blue-600 opacity-20 blur-md group-hover:opacity-40 transition-all" />

                    <div className="relative w-14 h-14 rounded-2xl bg-linear-to-br from-cyan-500 to-blue-600 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
